...
export interface EvsdGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface EvsdGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): EvsdGovernor;
  waitForDeployment(): Promise<this>;

  interface: EvsdGovernorInterface;
  ...
  hasVotingRights: TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
