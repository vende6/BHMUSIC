...
export interface EvsdTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface EvsdToken extends BaseContract {
  connect(runner?: ContractRunner | null): EvsdToken;
  waitForDeployment(): Promise<this>;

  interface: EvsdTokenInterface;
